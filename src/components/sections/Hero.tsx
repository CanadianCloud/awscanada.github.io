  ...
  return (
    <section id="about" className="relative isolate flex min-h-screen items-center justify-center overflow-hidden text-white px-4 sm:px-6">
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center">
        ...
        <button className="cursor-pointer mt-6 sm:mt-8 px-6 sm:px-8 py-3 sm:py-4 rounded-full bg-aws-orange text-sm sm:text-base tracking-[0.15em] sm:tracking-[0.2em] text-black transition-all duration-200 shadow-md hover:bg-aws-orange-dark hover:shadow-lg transform hover:-translate-y-0.5 active:scale-95 min-h-[48px]">
