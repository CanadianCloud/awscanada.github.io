      ...
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        <div className="flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16">
          ...
          <div className="flex-1 w-full space-y-4 sm:space-y-6">
            ...
            <div className="pt-2">
              <button className="bg-aws-orange hover:bg-aws-orange-dark text-black px-6 sm:px-8 py-3 sm:py-3.5 rounded-full transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 active:scale-95 inline-flex items-center text-sm sm:text-base min-h-[48px]">
