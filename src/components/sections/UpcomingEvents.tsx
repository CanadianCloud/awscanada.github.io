            ...
            >
              <div className="flex flex-col md:flex-row p-4 sm:p-6 gap-4 sm:gap-6">
                ...
                <div className="flex-1">
                  ...
                  <button className="bg-aws-orange hover:bg-aws-orange-dark text-black px-5 sm:px-6 py-3 rounded-full transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 active:scale-95 inline-flex items-center text-sm sm:text-base min-h-[44px]">
                    {event.buttonText}
                  </button>
                </div>
              </div>
